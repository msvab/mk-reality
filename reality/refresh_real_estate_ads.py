...
from .ads_refresh_pipeline import city_refresh_summary, format_delta
from .paths import (
    HTML_PATH,
    REAL_ESTATE_ADS_BY_CITY_PATH,
    REAL_ESTATE_RAW_DIR,
    REAL_ESTATE_RUN_STATE_PATH,
    REALITY_IDNES_LOCALITY_ID_CACHE_PATH,
...
def commit_and_push(message: str, push: bool) -> None:
    ...
    run_command(
        [
            ...
            str(REALITY_IDNES_LOCALITY_ID_CACHE_PATH.relative_to(ROOT)),
