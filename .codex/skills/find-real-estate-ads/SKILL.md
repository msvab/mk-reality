...
- Use a compact machine-readable `notes` convention for recurring caveats and provenance, for example `snapshot-sufficient`, `duplicate-merged-from:mmreality.cz`, `duplicate-price:mmreality.cz=6390000`, `missing-public-sewer`, `mixed-residential-recreational`.
